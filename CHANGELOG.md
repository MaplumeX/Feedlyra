...
- **Settings**: new About tab showing the app version.

### Changed

- **Settings**: redesign the settings dialog with stable sizing across tabs
  and a minimal text-style tab navigation.
- **UI**: align with DESIGN.md — introduce a warning token, fix visual drift,
  and complete i18n coverage.
